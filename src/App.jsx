...
function App() {
  ...
  return (
    <>
      <div className="bg-red-800 h-lvh flex gap-10 text-white">
        {/* FORM */}
        <div className="w-1/4 h-lvh flex flex-col justify-center items-center">
          {editShow ? (
            <>
              <h1 className="text-2xl text-black py-5 font-dark">
                Edit Details
              </h1>
              <form
                action=""
              ...
              >
                ...
                <div className="flex justify-evenly mt-5">
                  <button
                    ...
                    type="submit"
                    className="px-3 py-2  bg-green-600 text-white rounded hover:bg-slate-800 hover:text-white  hover:border"
                  >
                    Save
                  </button>
                </div>
            ...
            <div className=" pt-5">
              <h1 className="text-3xl leading-relaxed text-black font-dark">
        ...
        <div className="w-3/4 flex flex-col justify-center  mx-5">
          <table className="table-auto w-full">
            <thead>
              <tr>
                <th className="border border-slate-900 p-2">Employee ID</th>
                <th className="border border-slate-900 p-2">Username</th>
                <th className="border border-slate-900 p-2">Email</th>
                <th className="border border-slate-900 p-2">Status</th>
                <th className="border border-slate-900 p-2">Action</th>
              </tr>
            </thead>
            <tbody>
              {allEmployees?.length > 0 ? (
                allEmployees.map((emp) => (
                  <tr key={emp?.id}>
                    ...
                    <td className="border border-slate-900 p-2 flex justify-evenly">
                      <button
                        onClick={() => editEmployee(emp?.id)}
                        className="border hover:bg-black hover:text-white py-2 rounded w-28"
                      >
                        Edit
                      </button>
                      <button
          ...
          <div className="">
            <h1 className="text-2xl decoration-gray-900 py-5 font-light">
              Add Employee
            </h1>
            <form
              action=""
            ...
            >
              ...
              <div className="flex justify-end gap-5 mt-5">
                <button
                  onClick={resetButton}
                  type="reset"
                  className="px-3 py-2 bg-slate-300 text-black rounded hover:bg-slate-800 hover:text-white  hover:border"
                >
                  Reset
                </button>
                <button
                  ...
                  type="submit"
                  className="px-10 py-2 bg-slate-400 text-white rounded hover:bg-slate-800 hover:text-white  hover:border"
                >
                  Save
                </button>
              </div>
